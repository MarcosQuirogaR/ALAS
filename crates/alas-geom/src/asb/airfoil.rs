...
// Ported from aerosandbox/geometry/airfoil/airfoil.py,
// aerosandbox/geometry/airfoil/airfoil_families.py
// Upstream: AeroSandbox 4.2.8, MIT.
// Reference: alas @ rust-port-baseline.

//! AeroSandbox's `Airfoil`, scoped to the surface this program's Python
...
//! repaneling through a cubic spline, and thickness sampling.
//!
//! Everything else `Airfoil` offers upstream -- XFoil/NeuralFoil polars,
//! Kulfan parameterization, plotting, `normalize`, `scale`/`translate`,
//! `LE_radius`, `TE_angle`, `TE_thickness` -- is out of scope; a prior
//! research pass grepped every call this program's Python package makes onto
//! an `Airfoil` instance and none of those reach this module. `docs/PORTING.md`
//! records the scoping decision.
//!

...
fn public_planning_cg_uses_the_source_frame_without_becoming_a_certification_claim() {
    ...
    // from 19.617749 to 19.627197% in the published planning frame.
    assert!(
        (result.model_cg_pct_mac - 22.872_246_301_225_57).abs() < 1.0e-6,
    ...
    assert!(
        (public_pct_mac - 19.627_197_343_330_582).abs() < 1.0e-6,

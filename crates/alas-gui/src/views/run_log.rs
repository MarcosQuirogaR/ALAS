...
use crate::state::{AppState, LogKind, RunLogTab};
...
mod tests {
    ...
    use super::console::{format_elapsed, localize_log_text, render_line};
    use super::{display_stage_name, stage_groups, stage_status, StageStatus};

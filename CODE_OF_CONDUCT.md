...
[GitHub's private reporting](https://github.com/MarcosQuirogaR/ALAS/security/advisories/new)
...
behaviour. *Consequence:* a private warning, with clarity about the nature of
the violation; a public apology may be requested.

**2. Warning.** *Impact:* a violation through a single incident or series of
actions. *Consequence:* a warning with consequences for continued behaviour,
and no interaction with those involved for a specified period.
...
**4. Permanent ban.** *Impact:* demonstrating a pattern of violation, or
harassment of an individual or class of individuals. *Consequence:* a permanent
